...
Quests can unlock ambushes. Quests can also allow for the player to recieve an item that can be renamed to summon an ambush on the player it is renamed to.
...
# AMBUSH 1.1.4 optional ship stack
